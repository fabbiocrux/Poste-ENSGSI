...
Les enseignements ont été dispensés à des niveaux BAC+3, à BAC +5, principalement en travaux dirigés dans différents pôles d’enseignement (Figure 2).

```{r}

```

La majorité de mes enseignements (91 %) est dispensée au sein des pôles de Conception et Innovation et Génie Mécanique Energétique.


Mes thématiques d’enseignement portent majoritairement sur 
