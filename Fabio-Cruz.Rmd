...
output:
   bookdown::pdf_document2:
     ...
     includes:
       in_header: assets/packages.tex
       before_body: assets/titlepage.tex
...
```{r, echo=FALSE, out.width = '75%', fig.align='center', fig.cap="Nuages de mots fait à partir des résumés des mes articles scientifiques"}
#download.file(paste0(URL, 'Fabio/Fabio-300x300.jpg'), "Dossier/Figures/Fabio.jpg", mode = "wb")
