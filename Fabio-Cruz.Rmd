...
<!-- INEDIT -->
Actuellement, je participe au développement du démonstrateur [Green Fablab](https://lf2l.fr/projects/green-fablab/)^[https://lf2l.fr/projects/green-fablab/] dans le cadre du projet Européen H2020 INEDIT. 
...
Ensuite, au vu des impacts écologiques que la surproduction et surconsommation ont sur la capacité de charge de nos écosystèmes,  il est impératif de favoriser des compétences pour prioriser le ‘droit à la réparation’ ^[Plus de détails dur la comunication officiel de l’EU: (https://www.europarl.europa.eu/news/en/headlines/society/20220331STO26410/why-is-the-eu-s-right-to-repair-legislation-important)]. Développement d'outils à faible coût, gratuits et à codes sources ouverts, fabriqués numériquement (idéalement à partir de déchets recyclés) pour permettre la création des moyens de production y compris  des outils scientifiques.
